...
# @scaffold:file_hash sha256:45ed431b9e129cff93401970dfce507beb2420e6fada2379d75f87ec7235b186
#
...
from processes.fixture_tenant.gate_probe_read_only.c_gpreadon.constants import STEP_RESOLVE_READ_WORKSPACE
...
@activity.defn(name="resolve_read_workspace_stepreso_c_gpreadon")
async def resolve_read_workspace_stepreso(
    ...
    async with platform.for_tenant(input.tenant_code) as p:
        ...
        if _expr_val_repo_key is not None:
            ...
            expressions["repo_key"] = "petclinic"
