...
# @scaffold:file_hash sha256:17eabdbc3973e3a95551cb902cb660f5b53072d3d21b662cd0694e565366815f
#
...
from processes.fixture_tenant.gate_probe_read_only.c_gpreadon.constants import STEP_GATE_PROBE_CODE
...
@activity.defn(name="gate_probe_code_stepcode_c_gpreadon")
async def gate_probe_code_stepcode(
    ...
    async with platform.for_tenant(input.tenant_code) as p:
        ...
        config: dict[str, Any] = {"max_turns": 40, "timeout_seconds": 900}
        if connection_id:
        ...
        if _expr_val_task is not None:
            ...
            expressions["task"] = "List the files at the repository root with Glob and stop by calling complete_step with a one-sentence summary. Do not write or change anything."
