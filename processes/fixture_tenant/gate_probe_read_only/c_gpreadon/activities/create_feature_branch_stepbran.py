...
# @scaffold:file_hash sha256:9c44bba94559d9d33f8f5fed4d62f0d907e8983ebb379b9cfbc043abd5089021
#
...
from processes.fixture_tenant.gate_probe_read_only.c_gpreadon.constants import STEP_CREATE_FEATURE_BRANCH
...
@activity.defn(name="create_feature_branch_stepbran_c_gpreadon")
async def create_feature_branch_stepbran(
    ...
    async with platform.for_tenant(input.tenant_code) as p:
        ...
        if _expr_val_context_id is not None:
            ...
            expressions["context_id"] = "probe-ro1"
