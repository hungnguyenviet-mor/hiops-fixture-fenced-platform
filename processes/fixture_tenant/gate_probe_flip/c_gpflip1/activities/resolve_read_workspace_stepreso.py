...
# @scaffold:file_hash sha256:79cdefaba98a0669c765026852f1b24395c16540d9a7c2c0b88d59c11e3e7acb
#
...
from processes.fixture_tenant.gate_probe_flip.c_gpflip1.constants import STEP_RESOLVE_READ_WORKSPACE
...
@activity.defn(name="resolve_read_workspace_stepreso_c_gpflip1")
async def resolve_read_workspace_stepreso(
    ...
    async with platform.for_tenant(input.tenant_code) as p:
        ...
        if _expr_val_repo_key is not None:
            ...
            expressions["repo_key"] = "flip-probe"
