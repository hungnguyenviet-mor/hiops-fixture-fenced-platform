...
# @scaffold:file_hash sha256:0afe43a9d5404649b32ecd23f4f8d990c309ef072550acef06824ec489468258
#
...
from processes.fixture_tenant.gate_probe_flip.c_gpflip1.constants import STEP_CREATE_FEATURE_BRANCH
...
@activity.defn(name="create_feature_branch_stepbran_c_gpflip1")
async def create_feature_branch_stepbran(
    ...
    async with platform.for_tenant(input.tenant_code) as p:
        ...
        if _expr_val_context_id is not None:
            ...
            expressions["context_id"] = "probe-flip1"
