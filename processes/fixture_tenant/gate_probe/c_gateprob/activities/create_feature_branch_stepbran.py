...
# @scaffold:file_hash sha256:f2300439a5a8f4b59a7312a72fad71f225573a843bef4a5be3bb148e076871cb
#
...
from processes.fixture_tenant.gate_probe.c_gateprob.constants import STEP_CREATE_FEATURE_BRANCH
...
@activity.defn(name="create_feature_branch_stepbran_c_gateprob")
async def create_feature_branch_stepbran(
    ...
    async with platform.for_tenant(input.tenant_code) as p:
        ...
        if _expr_val_context_id is not None:
            ...
            expressions["context_id"] = "probe-001"
